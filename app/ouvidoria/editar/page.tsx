...
import { Alternativa, Avaliacao, Pergunta } from "@/types";
import {
  Select,
  SelectContent,
  SelectGroup,
...
export default function FormOvedoria() {
  ...
  const [formulario, setFormulario] = useState<Avaliacao>();
    ...
    <Card className="md:w-full h-full bg-white">
      ...
      <CardContent className="px-8 py-10">
        ...
        <Button disabled={!tituloformulario || !descricaoformulario || perguntas.length == 0}
                className="mt-3 bg-green-600 text-white h-10 w-full" onClick={criaAvaliacao}>
          Salvar avaliação
        </Button>
